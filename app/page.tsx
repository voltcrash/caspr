        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            <div className="flex items-center">
              <h1 className="text-2xl font-bold text-orange-500">CASPR</h1>
            </div>
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
        <div className="text-center">
          ...
          <div className="flex justify-center gap-4">
            <Link
              href="/register"
              className="px-8 py-3 text-lg font-medium text-white bg-orange-500 rounded-lg hover:bg-orange-600 shadow-lg hover:shadow-xl transition-all"
            >
              Get Started
            </Link>
            <Link
              href="/login"
              className="px-8 py-3 text-lg font-medium text-orange-500 bg-gray-900 rounded-lg hover:bg-gray-700 border-2 border-orange-500 transition-all"
            >
              Sign In
            </Link>
          </div>
