      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
        <div className="text-center">
          ...
          <div className="flex justify-center gap-4">
            <Link
              href="/register"
              className="px-8 py-3 text-lg font-medium text-white bg-orange-600 rounded-lg hover:bg-orange-700 shadow-lg hover:shadow-xl transition-all"
            >
              Get Started
            </Link>
            <Link
              href="/login"
              className="px-8 py-3 text-lg font-medium text-orange-500 bg-gray-800 rounded-lg hover:bg-gray-700 border-2 border-orange-600 transition-all"
            >
              Sign In
            </Link>
          </div>
